...
class RestUtil {
      ...
      * @return RestUtil
      */
     public static function get($url,$params=null,array $headers=null,$user=null,$pwd=null) {
     	return self::call("GET",$url,$params,$headers,$user,$pwd);
     }
      ...
      * @return RestUtil
      */
     public static function post($url,$params=null,array $headers=null,$user=null,$pwd=null,$contentType="multipart/form-data") {
         return self::call("POST",$url,$params,$headers,$user,$pwd,$contentType);
     }
      ...
      * @return RestUtil
      */
     public static function put($url,$body,array $headers=null,$user=null,$pwd=null,$contentType=null) {
         return self::call("PUT",$url,$body,$headers,$user,$pwd,$contentType);
     }
      ...
      * @return RestUtil
      */
     public static function delete($url,array $params=null,array $headers=null,$user=null,$pwd=null) {
         return self::call("DELETE",$url,$params,$headers,$user,$pwd);
     }
      ...
      * @return RestUtil
      */
     public static function call($method,$url,$body,array $headers=null,$user=null,$pwd=null,$contentType=null) {
