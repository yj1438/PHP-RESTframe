...
abstract class kintParser extends kintVariableData
{
	...
	{
		isset( self::$_customDataTypes ) || self::_init();
		...
		$varType === 'unknown type' && $varType = 'unknown'; # PHP 5.4 inconsistency
	...
	{
		isset( self::$_marker ) || self::$_marker = "\x00" . uniqid();
...
class kintVariableData
{
	...
	{
		$encoding || $encoding = self::_detectEncoding( $value );
	...
	{
		$encoding || $encoding = self::_detectEncoding( $string );
